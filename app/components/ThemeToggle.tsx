...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      disabled={!isHydrated}
      className={`inline-flex items-center justify-center h-9 w-9 rounded-md border select-none outline-none focus:outline-none focus:ring-0 transition-colors duration-200 ${
        isDark
          ? 'bg-dark-bg-tertiary border-[#334155] hover:bg-dark-bg-card'
          : 'bg-light-bg-secondary border-light-border hover:bg-light-bg-tertiary'
      }`}
