        ...
        <div className="mb-6">
          ...
          <div className="relative group">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="absolute inset-y-0 right-2 flex items-center px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group/btn"
            >
              {isLoading ? (
                ...
                <>
                  <span className="hidden sm:block mr-2 font-medium">Search</span>
